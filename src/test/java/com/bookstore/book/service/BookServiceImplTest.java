...
class BookServiceImplTest {
    ...
    void setUp() {
        ...
        book = Book.builder()
                ...
                .stockQuantity(10)
                .imageKey("uploads/clean-code.jpg")
        ...
        /*
         * BookServiceImpl generates a presigned URL when converting
         * a Book entity into a BookResponse.
         *
         * Some tests do not call this method, so lenient() prevents
         * Mockito's strict-stubbing mode from reporting unnecessary
         * stubbing.
         */
        lenient()
    ...
    void createBook_shouldThrowExceptionWhenIsbnAlreadyExists() {
        ...
        assertTrue(
                exception.getMessage().contains("ISBN")
        );
    ...
    void getBookById_shouldThrowExceptionWhenBookDoesNotExist() {
        ...
        assertTrue(
                exception.getMessage().contains("Book not found")
        );
    ...
    void updateBook_shouldUpdateBookSuccessfully() {
        ...
        BookUpdateRequest request =
                BookUpdateRequest.builder()
                        ...
                        .imageKey("uploads/new-image.jpg")
                        .active(true)
                        .build();
